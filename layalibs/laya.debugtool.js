...
(function(window,document,Laya){
	...
	var Filter=laya.filters.Filter,Font=laya.display.css.Font,GrahamScan=laya.maths.GrahamScan,Graphics=laya.display.Graphics;
	var HTMLCanvas=laya.resource.HTMLCanvas,Handler=laya.utils.Handler,HitArea=laya.utils.HitArea,Image=laya.ui.Image;
	var Input=laya.display.Input,Label=laya.ui.Label,List=laya.ui.List,Loader=laya.net.Loader,LoaderManager=laya.net.LoaderManager;
	var LocalStorage=laya.net.LocalStorage,MathUtil=laya.maths.MathUtil,Matrix=laya.maths.Matrix,Node=laya.display.Node;
	...
	*/
	...
	var Main=(function(){
		function Main(){
			...
			Font.defaultColor="#ff0000";
			Laya.stage.scaleMode=/*laya.display.Stage.SCALE_SHOWALL*/"showall";
			DebugPanel.init();
			this.testMask();
			console.log(Base64Tool.encodeStr("yyuuu"));
			console.log(Base64Tool.encodeStr2("yyuuu"));
		}

		__class(Main,'Main');
		var __proto=Main.prototype;
		__proto.testMask=function(){
			var sprite1;
			sprite1=new Sprite();
			sprite1.graphics.drawRect(0,0,100,100,"#00ff00");
			sprite1.pos(300,100);
		...
		__proto.testArrInsert=function(){
			var srcArr;
			srcArr=[0,1,2,3,4,5,6];
			var insertArr;
			insertArr=[99,99,99];
			ObjectTools.insertArrToArr(srcArr,insertArr,3);
			console.log(srcArr);
		}

		__proto.TestLoader=function(){
			console.log("TestLoader");
			var img;
			img=new Image();
			Laya.stage.addChild(img);
			img.skin="data:image/png;base64,";
		}
		...
		__proto.createTestSps=function(){
			...
			txt.visible=false;
			sp.addChild(txt);
			Laya.timer.loop(100,this,this.changeTxt,[txt]);
			Laya.stage.addChild(sp);
			tar=sp;
			sp=new Sprite();
			sp.name="hello2";
			sp.cacheAsBitmap=true;
			sp.graphics.drawRect(0,0,100,100,"#ff00ff");
			sp.pos(250,200);
			Laya.stage.addChild(sp);
			sp=new Sprite();
			sp.name="hello3";
			sp.cacheAsBitmap=true;
			sp.graphics.drawRect(0,0,100,100,"#ffffff");
			sp.pos(225,250);
			Laya.stage.addChild(sp);
		}

		//Laya.timer.once(5000,this,analyseNodeVisible,[tar]);
		__proto.testCall=function(){
			this.testFunF.__proto__.call=this.emFun;
			this.testFunF.__proto__.apply=this.emFun;
			this.testFunF();
			this.testFunF.call();
			this.testFunF.apply();
		}

		__proto.emFun=function(){
			console.log("emFun");
		}

		__proto.testFunF=function(){
			console.log("testFunF");
		}

		__proto.changeTxt=function(txt){
			txt.text="aa"+Math.random();
		}

		__proto.analyseNodeVisible=function(tar){
			VisibleAnalyser.analyseTarget(tar);
		}

		//Laya.stage.addChild(visibleSprite);
